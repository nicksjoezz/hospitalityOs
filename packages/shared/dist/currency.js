...
function getCurrency(code) {
    ...
    return (exports.CURRENCIES[upper] ?? {
        code: upper,
 ...
 */
function convertMinor(amountMinor, from, to, fxRate) {
...
function formatMoney(amountMinor, code) {

...
export const ROUTES: AppRoute[] = [
  ...
  { path: '/staff', label: 'Staff', element: <Staff />, roles: [] },
  { path: '/users', label: 'Accounts', element: <Users />, roles: [] },
  { path: '/payroll', label: 'Payroll', element: <Payroll />, roles: [] },
  { path: '/security', label: 'Security', element: <Security />, feature: Feature.SECURITY_REPORTS, roles: ['SECURITY'] },
  { path: '/staff-reports', label: 'HR Reports', element: <StaffReports />, feature: Feature.SECURITY_REPORTS, roles: [] },
